...
(0, _scroll.messageWrap).addEventListener("scroll", (0, _scroll.showMessagesHistory));
...
const UI_ELEMENTS = {
    ...
    MESSAGES_WRAP: document.querySelector(".dialog__message-box"),
    POPUP_AUTHORIZATION: document.querySelector("#authorization"),
    POPUP_SETTINGS: document.querySelector("#settings"),
    INPUT_MESSAGE: document.querySelector(".dialog__message-input"),
    INPUT_EMAIL: document.querySelector("#authorization_mail_input"),
    INPUT_AUTHORIZATION: document.querySelector("#authorization_code_input"),
    INPUT_USERNAME: document.querySelector(".popup__input-name"),
    BUTTON_SUBMIT: document.querySelector(".dialog__message-submit"),
    BUTTON_SETTINGS: document.querySelector(".dialog__btn-settings"),
    BUTTON_CLOSE: document.querySelectorAll(".popup__header-close"),
    BUTTON_SIGN_UP: document.querySelector(".dialog__btn-exit"),
    BUTTON_EMAIL_INPUT: document.querySelector("#authorization_mail"),
    BUTTON_AUTHORIZATION: document.querySelector("#authorization_code"),
    BUTTON_NAME_INPUT: document.querySelector(".popup__submit"),
    SCROLL_TOP: document.querySelector(".arrow")
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"kCoL0":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "popupAuthorization", ()=>popupAuthorization);
...
var _viewJs = require("./view.js");
const popupSettings = (0, _viewJs.UI_ELEMENTS).POPUP_SETTINGS;
const popupAuthorization = (0, _viewJs.UI_ELEMENTS).POPUP_AUTHORIZATION;
const closePopup = (0, _viewJs.UI_ELEMENTS).BUTTON_CLOSE;
...
parcelHelpers.export(exports, "loadMail", ()=>loadMail);
parcelHelpers.export(exports, "setLocalHistory", ()=>setLocalHistory);
parcelHelpers.export(exports, "getHistoryStorage", ()=>getHistoryStorage);
...
const buttonAuthorization = (0, _viewJs.UI_ELEMENTS).BUTTON_AUTHORIZATION;
const inputEmail = (0, _viewJs.UI_ELEMENTS).INPUT_EMAIL;
const inputAuthorization = (0, _viewJs.UI_ELEMENTS).INPUT_AUTHORIZATION;
...
async function setLocalHistory() {
    try {
...
function renderHistory() {
    ...
    json = json.reverse();
    getDataMessage(json);
    (0, _scroll.scrollToBottom)();
}
function getDataMessage(json) {
...
function loadHistory(text, name, date, email, json) {
    const message = (0, _messageJs.templateMessage).content.cloneNode(true);
...
function isHasHistory(json, message) {
    ...
    if (array.length + 20 === parseHistory.length) (0, _messageJs.listMessages).append(message);
    else (0, _messageJs.listMessages).prepend(message);
}
function setMessage(message, text, name, date, email) {
    message.querySelector(".dialog__message-text").textContent = `${name}: ${text}`;
    let createdDate = (0, _dateFns.format)(new Date(date), "dd.MM");
    let currentDate = (0, _dateFns.format)(new Date(), "dd.MM");
    let messageDate;
    if (createdDate === currentDate) messageDate = (0, _dateFns.format)(new Date(date), "HH:mm");
    else messageDate = (0, _dateFns.format)(new Date(date), "dd.MM HH:mm");
...
function isOwnMessage(email, message) {
    const emailCookie = (0, _jsCookieDefault.default).get("email");
    if (email === emailCookie) message.querySelector(".dialog__message").classList.add("dialog__personal_message");
    else message.querySelector(".dialog__message").classList.add("dialog__someone_message");
}

},{"./view.js":"2GA9o","./message.js":"lGCpb","js-cookie":"c8bBu","date-fns":"9yHCA","./modal":"guy4I","./scroll":"ox3Ut","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"lGCpb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "templateMessage", ()=>templateMessage);
parcelHelpers.export(exports, "listMessages", ()=>listMessages);
...
function getNewMessage() {
    ...
    isValidInput();
    socketSend(message);
    (0, _load.setLocalHistory)();
    (0, _scroll.scrollToBottom)();
}
function socketSend(message) {
    (0, _load.socket).send(JSON.stringify({
        text: message
    }));
}
...
},{"./view.js":"2GA9o","./load":"jOeeP","./scroll":"ox3Ut","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"ox3Ut":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "messageWrap", ()=>messageWrap);
...
var _load = require("./load");
let messageWrap = (0, _view.UI_ELEMENTS).MESSAGES_WRAP;
const scrollTop = (0, _view.UI_ELEMENTS).SCROLL_TOP;
function scrollToBottom() {
    messageWrap.scrollTop = messageWrap.scrollHeight;
}
function showMessagesHistory() {
    if (messageWrap.scrollTop === 0 && (0, _load.array).length !== 0) {
        scrollTop.classList.add("arrow-visible");
        console.log("Подгружаю еще 20 сообщений...");
        let json = (0, _load.array).splice(0, 20);
        (0, _load.getDataMessage)(json);
        scrollTop.addEventListener("click", getToTop);
    }
}
function getToTop() {
    let array = JSON.parse((0, _load.getHistoryStorage)());
...
},{"./view":"2GA9o","./load":"jOeeP","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"c8bBu":[function(require,module,exports) {
...
},{"../_lib/toInteger/index.js":"f7kKX","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"f7kKX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"fsust":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"9wUgQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"lnm6V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../isDate/index.js":"kqNhT","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"kqNhT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../_lib/requiredArgs/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"lL2M9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../addMilliseconds/index.js":"7Tp9s","../_lib/requiredArgs/index.js":"9wUgQ","../_lib/toInteger/index.js":"f7kKX","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"3cYKM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"4nEkI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../startOfUTCISOWeek/index.js":"3ta4C","../startOfUTCISOWeekYear/index.js":"4u8O6","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"3ta4C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"4u8O6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../getUTCISOWeekYear/index.js":"03QaQ","../startOfUTCISOWeek/index.js":"3ta4C","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"03QaQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","../startOfUTCISOWeek/index.js":"3ta4C","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"b7GgV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../startOfUTCWeek/index.js":"dDZbE","../startOfUTCWeekYear/index.js":"bJAVl","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"dDZbE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","../toInteger/index.js":"f7kKX","../defaultOptions/index.js":"dWs8l","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"dWs8l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"bJAVl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../getUTCWeekYear/index.js":"8i6st","../requiredArgs/index.js":"9wUgQ","../startOfUTCWeek/index.js":"dDZbE","../toInteger/index.js":"f7kKX","../defaultOptions/index.js":"dWs8l","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"8i6st":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","../startOfUTCWeek/index.js":"dDZbE","../toInteger/index.js":"f7kKX","../defaultOptions/index.js":"dWs8l","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"6pP6x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"9oZiA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../addLeadingZeros/index.js":"6pP6x","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"1ztit":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"bc74C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"4R0Xq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"1rVeP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../locale/en-US/index.js":"8XKCq","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"8XKCq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./_lib/formatDistance/index.js":"lLrcE","./_lib/formatLong/index.js":"cA6Xb","./_lib/formatRelative/index.js":"9QlMp","./_lib/localize/index.js":"jv1Fa","./_lib/match/index.js":"1wA2o","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"lLrcE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"cA6Xb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildFormatLongFn/index.js":"h1FGd","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"h1FGd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"9QlMp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"jv1Fa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildLocalizeFn/index.js":"5l2rZ","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"5l2rZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"1wA2o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildMatchFn/index.js":"2nEf9","../../../_lib/buildMatchPatternFn/index.js":"4GjCS","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"2nEf9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"4GjCS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"iOhcx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function getMessageSocket() {
    try {
        (0, _loadJs.socket).onmessage = function(event) {
...
function sendMessage(name, text, date) {
    const message = (0, _message.templateMessage).content.cloneNode(true);
    (0, _loadJs.setMessage)(message, text, name, date);
    (0, _message.listMessages).append(message);
}

},{"./load.js":"jOeeP","./message":"lGCpb","./scroll":"ox3Ut","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"3QxmH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _modal = require("./modal");
function setUser() {
    const name = (0, _view.UI_ELEMENTS).INPUT_USERNAME.value;
    setUserName(name);
    (0, _modal.closeSettings)();
    (0, _load.setLocalHistory)();
}
async function setUserName(name) {
    try {
        const response = await fetch(`https://${(0, _load.URL)}/api/user`, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json;charset=utf-8",
                "Authorization": `Bearer ${(0, _load.getToken)()}`
            },
            body: JSON.stringify({
                name: name
            })
...
async function getUser() {
    try {
        const response = await fetch(`https://${(0, _load.URL)}/api/user/me`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json;charset=utf-8",
                "Authorization": `Bearer ${(0, _load.getToken)()}`
