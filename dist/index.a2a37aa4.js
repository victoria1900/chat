...
},{"./view":"aqQhS","./socket":"h9fI8","./message":"3AcNn","./user":"i1r2y","./scroll":"iUOVa","./modal":"lXND6","./load":"gcEfs"}],"aqQhS":[function(require,module,exports) {
...
},{}],"h9fI8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "socket", ()=>socket);
parcelHelpers.export(exports, "socketConnect", ()=>socketConnect);
parcelHelpers.export(exports, "socketSend", ()=>socketSend);
var _message = require("./message");
var _load = require("./load");
const socket = new WebSocket(`ws://${(0, _load.URL)}/websockets?${(0, _load.getToken)()}`);
function socketConnect() {
    try {
        (0, _message.getMessageSocket)();
    } catch (err) {
        console.log(err);
    }
}
...
function getMessageSocket() {
    try {
        (0, _socket.socket).onmessage = function(event) {
...
},{"./view":"aqQhS","./load":"gcEfs","./scroll":"iUOVa","./socket":"h9fI8","./utils":"e4Zav","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"gcEfs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function setLocalHistory() {
    try {
        ...
        localStorage.setItem("history", (0, _utils.getValidJson)(history));
    } catch (err) {
        console.log(err);
    }
}
...
function setMessage(message, text, name, date, email) {
    const createdDate = (0, _dateFns.format)(new Date(date), "dd.MM");
    const currentDate = (0, _dateFns.format)(new Date(), "dd.MM");
    const messageDate = createdDate === currentDate ? (0, _dateFns.format)(new Date(date), "HH:mm") : (0, _dateFns.format)(new Date(date), "dd.MM HH:mm");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"lXND6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./view":"aqQhS","@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"iUOVa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function scrollToBottom() {
    (0, _view.UI_ELEMENTS).MESSAGES_WRAP.scrollTop = (0, _view.UI_ELEMENTS).MESSAGES_WRAP.scrollHeight;
}
function showMessagesHistory() {
    const isHasMessageHistory = (0, _view.UI_ELEMENTS).MESSAGES_WRAP.scrollTop === 0 && (0, _load.array).length !== 0;
    if (isHasMessageHistory) {
        const json = (0, _load.array).splice(0, 20);
        addArrow();
        (0, _load.getDataMessage)(json);
        (0, _view.UI_ELEMENTS).SCROLL_TOP.addEventListener("click", getToTop);
        console.log("Подгружаю еще 20 сообщений...");
    }
}
function addArrow() {
    (0, _view.UI_ELEMENTS).SCROLL_TOP.classList.add("arrow-visible");
}
function removeArrow() {
    (0, _view.UI_ELEMENTS).SCROLL_TOP.classList.remove("arrow-visible");
}
function getToTop() {
    getArray();
    (0, _view.UI_ELEMENTS).MESSAGES_WRAP.scrollTop = 0;
    removeArrow();
    (0, _view.UI_ELEMENTS).MESSAGES_WRAP.removeEventListener("scroll", showMessagesHistory);
    console.log("Вся история загружена");
}
function getArray() {
    const array = JSON.parse((0, _load.getHistoryStorage)());
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kCoL0"}],"i1r2y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
